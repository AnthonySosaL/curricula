...
const esData = {
  ...
  projects: [
    ...
    {
      name: 'Certis · Plataforma de Inglés C1',
      description: 'Plataforma de evaluación y práctica de inglés (CEFR A2-C1): examen de nivelación, refuerzo generado por IA y simulacros de speaking con un examinador de IA.',
      techs: ['Angular 22', 'ASP.NET Core', 'EF Core', 'SQL Server', 'Groq API', 'JWT'],
      github: null as string | null,
      demo: 'https://english-c1.runasp.net/' as string | null,
      live: true,
      color: '#0d9488',
      details: {
        summary: 'Plataforma completa de evaluación y práctica de inglés por niveles CEFR (A2 a C1): examen de nivelación de opción múltiple, refuerzo con preguntas generadas por IA, simulacros de speaking con un examinador de IA al estilo Cambridge, y un panel de administración/tutoría con seguimiento real de estudiantes.',
        highlights: [
          'Arquitectura limpia en .NET (Domain / Application / Infrastructure / Api) con el algoritmo de nivelación como funciones puras, cubiertas por tests unitarios, sin dependencia de EF Core.',
          'Cinco áreas evaluadas (Gramática, Vocabulario, Reading, Listening, Speaking): el examen de nivelación creció de 32 a 64 preguntas a medida que se sumaban destrezas, manteniendo una duración razonable con muestreo aleatorio del banco de preguntas.',
          'Refuerzo generado con IA (Groq): preguntas nuevas y no repetidas por celda (nivel + destreza), validadas y reintentadas automáticamente si la respuesta no cumple el formato esperado.',
          'Panel "Coach" con IA: agrega todo el historial de intentos del estudiante por nivel y destreza en un solo diagnóstico de progreso, en vez de limitarse a un intento puntual.',
          'Generación de minicursos con IA: 8 a 11 diapositivas por nivel y destreza que combinan explicación con ejercicios interactivos autoevaluables (arrastrar y soltar o completar), más un mini-quiz calificado para saber si ya conviene pasar al refuerzo completo.',
          'Speaking con examinador de IA: cuatro escenarios al estilo de las partes de un examen Cambridge (entrevista, turno largo, tarea colaborativa, discusión abstracta), manteniendo el historial de la conversación con límite de turnos para no disparar el costo.',
          'Audio de Listening generado localmente con edge-tts (sin costo de API) en vez de un servicio de voz de pago.',
          'Panel de Admin/Tutor con roles reales (ASP.NET Identity): seguimiento de rendimiento por estudiante con alerta temprana, gestión del banco de preguntas (CRUD) y asignación de tutor — incluye un tutor de IA sembrado en la base para no depender de un humano.',
          'Desplegado en infraestructura de producción real (frontend y backend), con HTTPS y CORS configurados correctamente entre ambos dominios.',
        ],
        stack: [
          { label: 'Backend', items: 'ASP.NET Core · C# · Entity Framework Core · SQL Server · JWT · ASP.NET Identity' },
          { label: 'Frontend', items: 'Angular 22 · Angular Material 3 · SCSS · Signals' },
          { label: 'IA', items: 'Groq API (generación de preguntas, diagnóstico, speaking) · edge-tts (audio local)' },
          { label: 'Despliegue', items: 'MonsterASP.NET · HTTPS (Let\'s Encrypt) · SQL Server en producción' },
        ],
        numbers: ['64 preguntas de nivelación', '5 destrezas evaluadas', '4 escenarios de speaking con IA', 'Roles: Admin/Tutor/Estudiante'],
      },
    },
    {
      name: 'Praxis Togaf · Tablero de Arquitectura Empresarial',
      description: 'Tablero visual para el marco TOGAF ADM (11 fases), con generación automática de contenido por IA y exportación a PDF.',
      techs: ['Angular 22', 'ASP.NET Core', 'EF Core', 'SQL Server', 'Groq API', 'JWT'],
      github: null as string | null,
      demo: 'https://praxis-togaf.runasp.net/' as string | null,
      live: true,
      color: '#ca8a04',
      details: {
        ...
        highlights: [
          ...
          'Desplegado en producción real (MonsterASP.NET), verificado en vivo: generación con IA, registro de usuarios y el tablero de invitado funcionando contra la base de datos real.',
        ],
        stack: [
          { label: 'Backend', items: 'ASP.NET Core · C# · Entity Framework Core · SQL Server · JWT · ASP.NET Identity' },
          { label: 'Frontend', items: 'Angular 22 · Angular Material · Angular CDK (drag & drop) · Signals' },
          { label: 'IA', items: 'Groq API (openai/gpt-oss-20b) — genera las 11 fases TOGAF' },
          { label: 'Exportación', items: 'jsPDF + html2canvas (JPEG optimizado)' },
        ],
        numbers: ['11 fases TOGAF ADM', 'Uso sin cuenta', '3 proyectos por cuenta', 'Exportación a PDF'],
      },
    },
    {
...
const enData = {
  ...
  projects: [
    ...
    {
      name: 'Certis · English C1 Platform',
      description: 'English CEFR (A2-C1) assessment and practice platform with a placement test, AI-generated reinforcement, and AI examiner speaking simulations.',
      techs: ['Angular 22', 'ASP.NET Core', 'EF Core', 'SQL Server', 'Groq API', 'JWT'],
      github: null as string | null,
      demo: 'https://english-c1.runasp.net/' as string | null,
      live: true,
      color: '#0d9488',
      details: {
        summary: 'A complete English CEFR (A2 to C1) assessment and practice platform: a multiple-choice placement test, AI-generated reinforcement questions, Cambridge-style AI examiner speaking simulations, and an admin/tutor panel with real student tracking.',
        highlights: [
          'Clean Architecture in .NET (Domain / Application / Infrastructure / Api) with the placement algorithm as pure functions, unit-tested, with zero EF Core dependency.',
          'Five assessed skills (Grammar, Vocabulary, Reading, Listening, Speaking): the placement test grew from 32 to 64 questions as skills were added, keeping duration reasonable via random sampling from the question bank.',
          "AI-generated reinforcement (Groq): fresh, non-duplicate questions per (level, skill) cell, validated and auto-retried if the response doesn't match the expected shape.",
          '"Coach" panel powered by AI: aggregates a student\'s entire attempt history per level and skill into one progress diagnostic, instead of being limited to a single attempt.',
          'AI-generated mini-courses: 8-11 slides per level and skill mixing explanation with self-check interactive exercises (drag-and-drop or fill-in), plus a graded mini-quiz to gauge readiness for the full reinforcement quiz.',
          'AI examiner speaking practice: four Cambridge-exam-style scenarios (interview, long turn, collaborative task, abstract discussion), threading conversation history with a turn cap to keep cost bounded.',
          'Listening audio generated locally with edge-tts (no API cost) instead of a paid voice service.',
          'Admin/Tutor panel with real roles (ASP.NET Identity): per-student performance tracking with early-warning flags, question-bank CRUD, and tutor assignment — including a seeded AI Tutor persona so it doesn\'t depend on a human.',
          'Deployed to real production infrastructure (frontend and backend), with HTTPS and CORS correctly configured across both domains.',
        ],
        stack: [
          { label: 'Backend', items: 'ASP.NET Core · C# · Entity Framework Core · SQL Server · JWT · ASP.NET Identity' },
          { label: 'Frontend', items: 'Angular 22 · Angular Material 3 · SCSS · Signals' },
          { label: 'AI', items: 'Groq API (question generation, diagnostics, speaking) · edge-tts (local audio)' },
          { label: 'Deployment', items: 'MonsterASP.NET · HTTPS (Let\'s Encrypt) · production SQL Server' },
        ],
        numbers: ['64 placement questions', '5 skills assessed', '4 AI speaking scenarios', 'Admin/Tutor/Student roles'],
      },
    },
    {
      name: 'Praxis Togaf · Enterprise Architecture Board',
      description: 'Visual board for the TOGAF ADM framework (11 phases), with AI-generated content and PDF export.',
      techs: ['Angular 22', 'ASP.NET Core', 'EF Core', 'SQL Server', 'Groq API', 'JWT'],
      github: null as string | null,
      demo: 'https://praxis-togaf.runasp.net/' as string | null,
      live: true,
      ...
      details: {
        ...
        highlights: [
          ...
          'Deployed to real production infrastructure (MonsterASP.NET), verified live: AI generation, user registration, and the guest board all working against the real database.',
        ],
        stack: [
          { label: 'Backend', items: 'ASP.NET Core · C# · Entity Framework Core · SQL Server · JWT · ASP.NET Identity' },
          { label: 'Frontend', items: 'Angular 22 · Angular Material · Angular CDK (drag & drop) · Signals' },
          { label: 'AI', items: 'Groq API (openai/gpt-oss-20b) — generates the 11 TOGAF phases' },
          { label: 'Export', items: 'jsPDF + html2canvas (JPEG-optimized)' },
        ],
        numbers: ['11 TOGAF ADM phases', 'No account required', '3 projects per account', 'PDF export'],
      },
    },
    {
